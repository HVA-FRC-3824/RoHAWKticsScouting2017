 ...
 *         Created: 8/23/16
 */
public class LLD_DataSet extends LineScatterCandleRadarDataSet<LLD_Entry> implements ILLD_DataSet {

    private final static String TAG = "LLD_DataSet";
    ...
    public LLD_DataSet(List<LLD_Entry> yVals, String label) {
        super(yVals, label);
    }
